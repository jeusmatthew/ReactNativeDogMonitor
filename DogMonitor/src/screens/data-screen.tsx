    ...
    <SafeAreaView style={styles.safe_area}>
        ...
        <View style={styles.modal_container}>
          <TouchableWithoutFeedback>
            <View style={styles.modal_card_container}>
              ...
              <ActivityIndicator />
              {downloadingRoutine ? (
                <Text style={styles.text_downloading_data}>
                  Descargando datos...
                </Text>
              ) : null}
              {savingRoutine ? (
      ...
      <FlatList
        ...
        renderItem={({item}) => (
          <RoutineItem
            routine={item}
            downloadData={(value: boolean) => {
              setDownloadingRoutine(value);
            }}
            savingInDevice={(value: boolean) => {
              setSavingRoutine(value);
            }}
            deletingRoutine={(value: boolean) => {
              setDeleteingRoutine(value);
            }}
            refreshRoutines={() => {
              getRoutines();
            }}
