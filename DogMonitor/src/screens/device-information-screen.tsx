          ...
          <View style={styles.modal_container}>
            <TouchableWithoutFeedback>
              <View style={styles.modal_card_container}>
                ...
                <View>
                  <Text style={styles.modal_text_label}>
                ...
                <View style={styles.modal_buttons_container}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={async () => {
                      ...
                      await DeviceService.updateDeviceInformation({
                        name: deviceName,
                      });
                ...
                {isSendingDeviceName ? (
                  <ActivityIndicator
                    style={{marginBottom: 20}}></ActivityIndicator>
                ) : null}
              </View>
            </TouchableWithoutFeedback>
          </View>
          ...
          <View style={styles.text_input_view}>
            ...
            <View style={styles.device_sensor_row}>
                ...
                <>
                  ...
                  <View style={styles.green_tag}>
                    <Text style={styles.text_status}>Conectado</Text>
                  </View>
                </>
              ) : (
                <>
                  ...
                  <View style={styles.red_tag}>
                    <Text style={styles.text_status}>Desconectado</Text>
                  </View>
                </>
              )}
            </View>
