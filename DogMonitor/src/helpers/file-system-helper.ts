...
export namespace FileSystemHelper {
  export const writeFileInDownloads = async (
    data: string,
    fileName: string,
    extension: string,
  ): Promise<boolean> => {
    try {
      ...
      ToastAndroid.show(
        'Se han descargado los datos correctamente',
        ToastAndroid.SHORT,
      );
      return true;
    } catch (e) {
      console.log(e);
      ToastAndroid.show(
        'Error escribiendo en el almacenamiento interno',
        ToastAndroid.SHORT,
      );
      return false;
    }
  ...
  export const writeFileInPrivateFolder = async (
    data: string,
    fileName: string,
  ): Promise<boolean> => {
    try {
  ...
  export const writeFileInDocumentsFolder = async (
    data: string,
    fileName: string,
  ): Promise<boolean> => {
    try {
  ...
  export const writeFileInDocumentsFolderBase64 = async (
    data: string,
    fileName: string,
  ): Promise<boolean> => {
    try {
  ...
  export const computeUniqueName = (
    fileName: string,
    extension: string,
  ): string => {
    const currentDate = new Date();
  ...
  export const copyRoutineFolder = async (
    path: string,
    folderName: string,
  ): Promise<boolean> => {
