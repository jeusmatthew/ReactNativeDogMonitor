...
export namespace RoutineService {
  ...
  export const getRoutineById = async (
    ...
    try {
      const routineResponse: AxiosResponse = await axios.get(
        `${BASE_URL}/api/services/routine/${routineId}`,
      );
  ...
  export const getAudioFile = async (audioName: string): Promise<any> => {
    try {
      const routineResponse = await axios.get(
        `${BASE_URL}/dogMonitorFirmware/audio/${audioName}`,
  ...
  export const deleteRoutineById = async (
    ...
    try {
      const routineResponse: AxiosResponse = await axios.delete(
        `${BASE_URL}/api/services/routine/${routineId}/delete`,
      );
      const routine: Routine = routineResponse.data;
      return true;
    } catch (_error) {
  ...
  export const createRoutine = async (
    ...
    try {
      const routineResponse: AxiosResponse = await axios.post(
        `${BASE_URL}/api/services/routine`,
        input,
      );
      const routine: Routine = routineResponse.data;
      return routine;
  ...
  > => {
    try {
      const routineResponse: AxiosResponse = await axios.post(
        `${BASE_URL}/api/services/routine/stop`,
        {},
      );
